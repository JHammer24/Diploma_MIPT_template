...
% Чтобы правильно использовать пакеты caption и subcaption потребуется переписать настройки с помощью \captionsetup[figure]{} (см. Russian-Phd-LaTeX-Dissertation-Template-1.0.0)
% Нужно в целом перейти на новый шаблон
%\usepackage{caption}
