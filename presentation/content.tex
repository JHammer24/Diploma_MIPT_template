...
\begin{frame}{Нумерованные списки}
  \begin{enumerate}
    \item один
    \item два
    \item три
...
\note{
  ...
  Для раздельного вывода презентации и заметок на~разные экраны (как в~impress или powerpoint)
  можно использовать программу \textit{pdf-presenter-console}.
}
...
\begin{frame}{Комбинация списков}
  \begin{enumerate}
    \item \textbf{Задача 1}
      \begin{itemize}
        \item Подзадача 1-1
...
\begin{frame}[allowframebreaks]{Разделение слайда}
  Поясняющий текст
  \begin{itemize}
    \item Один
    \item Два
...
\begin{frame}{Одиночное изображение}
  \centering
...
\begin{frame}{Изображения по-вертикали}
  \centering
  \vfill
  \includegraphics[width=0.5\linewidth,height=0.1\textheight]{latex}
  
  \TeX
  \vfill
  \includegraphics[width=0.5\linewidth,height=0.2\textheight]{latex}
...
\begin{frame}{Изображения по-горизонтали}
  \begin{minipage}[t]{0.47\linewidth}
    \textbf{Составная \\ подпись 1}
    \center{\includegraphics[width=0.8\linewidth]{knuth1}}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.47\linewidth}
    \textbf{Составная \\ подпись 2}
    \center{\includegraphics[width=0.8\linewidth]{knuth2}}
  \end{minipage}
\end{frame}

\subsection{Линии}

\begin{frame}{Разделяющие линии}
...
\begin{frame}{Слои}
  \begin{itemize}
    \item<+-> Отдельные части слайдов можно показывать последовательно, заменяя информацию или акцентируя внимание на \alert<2>{важных фрагментах}
    \item<+-> \textbf{Жирный}, \textbf{Bold}
    \item<+-> \texttt{overlays}
    \item<+-> В Бимере это можно сделать при помощи слоёв (\texttt{overlays})
  \end{itemize}
\end{frame}
...
\begin{frame}{Слои}
  ...
  \pause
  --- поместить команду \texttt{\textbackslash pause} между частями,
  \pause
  которые следует показать отдельно.
\end{frame}

\begin{frame}{Перечисления}
  \begin{itemize}
    \item<1-> Этот будет виден
    \item<2> Проблема 2
    \item<3> Проблема 3
  \end{itemize}
\end{frame}
...
\begin{frame}[allowframebreaks]{Уравнения Максвелла}
  \centering{
    \small
...
\begin{frame}{Большой многоуровневый список}
  \begin{itemize}
    \item \textbf{Пункт 1}
    \begin{itemize}
      \itemi Подпункт 1-1
...
\begin{frame}{Четыре изображения}
  \centering
  \includegraphics[width=0.25\linewidth,angle=35]{latex}
  \includegraphics[width=0.25\linewidth,angle=135]{latex}\\
  \includegraphics[width=0.25\linewidth,angle=15]{latex}
  \includegraphics[width=0.25\linewidth,angle=-15]{latex}
\end{frame}
